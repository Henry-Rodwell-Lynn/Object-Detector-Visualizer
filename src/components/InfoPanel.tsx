const InfoPanel = () => {
  return (
    <div className="fixed top-4 left-4 bg-[#222222] text-white p-4 rounded-md shadow-lg border border-[#555] text-sm font-mono max-w-[300px]">
      <h1 className="text-lg font-bold text-[#ddd] mb-2">Object Detector Visualizer</h1>
      <p className="text-[#B9BAC2] mb-3">
      ...
      <p className="text-[#8A8B92]"><strong>Version:</strong> 1.0.0</p>
      
      <div className="border-t border-[#444] my-4"></div>

      <div className="flex flex-col gap-1 text-[#8A8B92]">
